...
const FriendsLeaderboard = () => {
  ...
  const addMatch = () => {
    // Just an example: randomly pick a winner and loser
    const winnerIdx = Math.floor(Math.random() * friends.length);
    let loserIdx = Math.floor(Math.random() * friends.length);
    while (loserIdx === winnerIdx) loserIdx = Math.floor(Math.random() * friends.length);
    ...
    setFriends((prev) => {
      ...
      return updated.sort((a, b) => b.rating - a.rating).map((f, idx) => ({ ...f, rank: idx + 1 }));
    });
  };
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-black italic tracking-tighter">CheckMateHQ</h1>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  <div className={`text-xl font-black w-8 ${friend.rank === 1 ? 'text-yellow-500' : 'text-neutral-600'}`}>
